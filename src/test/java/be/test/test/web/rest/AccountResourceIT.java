package be.test.test.web.rest;

import static be.test.test.web.rest.AccountResourceIT.TEST_USER_LOGIN;
import static org.assertj.core.api.Assertions.assertThat;
import static org.springframework.test.web.servlet.request.MockMvcRequestBuilders.*;
import static org.springframework.test.web.servlet.result.MockMvcResultMatchers.*;

import be.test.test.IntegrationTest;
import be.test.test.config.Constants;
import be.test.test.domain.User;
import be.test.test.repository.AuthorityRepository;
import be.test.test.repository.UserRepository;
import be.test.test.security.AuthoritiesConstants;
import be.test.test.service.UserService;
import be.test.test.service.dto.AdminUserDTO;
import be.test.test.service.dto.PasswordChangeDTO;
import be.test.test.service.dto.UserDTO;
import be.test.test.web.rest.vm.KeyAndPasswordVM;
import be.test.test.web.rest.vm.ManagedUserVM;
